...
function showResult(){
  ...
  document.getElementById("resultName").innerText = typeNames[mainCode] + " / サブ：" + typeNames[subCode];
  document.getElementById("resultText").innerText = typeText[mainCode] + " サブ要素として「" + typeNames[subCode] + "」の傾向も持っています。";
}
